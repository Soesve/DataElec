...
df_out_conso_quot_region.to_csv(chemin_sortie + 'conso_quot_region.csv', sep=';', index=False)
...
# Enregistrement du fichier dans Warehouse_CSV
df_out_conso_annuelle_type_region.to_csv(chemin_sortie + 'conso_annuelle_type_region.csv', sep=';', index=False)
...
# Enregistrement du fichier dans Warehouse_CSV
df_out_temp_quot_region.to_csv(chemin_sortie + 'temp_quot_region.csv', sep=';', index=False)
...
# Enregistrement du fichier dans Warehouse_CSV
df_out_imports_exports.to_csv(chemin_sortie + 'imports_exports.csv', sep=';', index=False)
...
# Enregistrement du fichier dans Warehouse_CSV
df_out_injection_quot_region.to_csv(chemin_sortie + 'injection_quot_region.csv', sep=';', index=False)
